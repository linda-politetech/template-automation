...
? When I click on "Continue with Microsoft account" button
   ...
   ? When User enter a valid username as "thao.tranthanh@politetech.com"
       Undefined. Implement with the following snippet:

         When('User enter a valid username as {string}', async function (string) {
           // Write code here that turns the phrase above into concrete actions
           return 'pending';
         });
   ...
   ? And User click on "Continue" button
       Undefined. Implement with the following snippet:
         ...
         When('User click on {string} button', async function (string) {
           // Write code here that turns the phrase above into concrete actions
           return 'pending';
         });

   ? And User enter a valid password as "Loppho#62thnb"
       Undefined. Implement with the following snippet:
